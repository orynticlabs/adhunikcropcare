...
import { formatCurrency } from "@/lib/cart-context"
    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <div className="relative h-[380px] sm:h-[480px] lg:h-[540px] overflow-hidden">
          ...
          {/* Overlays */}
          <div className="absolute inset-0 bg-gradient-to-r from-[--moss]/80 via-[--moss]/50 to-transparent" />
          ...
          <div className="absolute inset-x-0 bottom-0 pb-12 sm:pb-16">
            <div className="mx-auto max-w-7xl px-4">
              ...
              {/* Breadcrumb */}
              <nav className="mb-5 flex items-center gap-1.5 text-sm text-white/65">
                <Link href="/" className="hover:text-white transition-colors">Home</Link>
                <ChevronRight className="h-3.5 w-3.5" aria-hidden />
                <span className="text-white/90 font-medium">All Products</span>
              </nav>

              <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl text-white leading-none tracking-tight">
                Our Products
              </h1>
