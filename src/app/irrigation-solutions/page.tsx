  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#edf5f2] text-[#17382d]">
      ...
      <section className="relative overflow-hidden pb-16 pt-32 sm:pb-20 sm:pt-40 lg:min-h-[760px] lg:pb-24 lg:pt-44">
          ...
          <h1 className="mt-7 font-display text-4xl leading-[.92] sm:text-6xl lg:text-[7rem]">Water should move<span className="block italic text-[#16826d]">with purpose.</span></h1>
        ...
        <section id="water-flow" className="bg-[#075949] py-20 text-white sm:py-28">
          ...
          <div className="text-center"><p className="text-xs font-bold uppercase tracking-[.22em] text-[#9bd3c5]">The water journey</p><h2 className="mt-4 font-display text-4xl sm:text-6xl lg:text-7xl">From source to root.</h2></div>
        ...
        <section className="py-20 sm:py-28">
          <div className="mx-auto max-w-7xl px-4">
            ...
            <div className="relative min-h-[360px] overflow-hidden rounded-[2rem] sm:min-h-[440px] sm:rounded-[2.75rem] lg:col-span-2 lg:min-h-[520px]"><Image src="https://images.unsplash.com/photo-1530836369250-ef72a3f5cda8?w=1300&q=90" alt="Modern crop irrigation system" fill sizes="(max-width: 1024px) 100vw, 66vw" className="object-cover" /><div className="absolute inset-0 bg-gradient-to-t from-[#06483b]/80 via-transparent to-transparent" /><div className="absolute bottom-6 left-6 max-w-xl pr-6 text-white sm:bottom-8 sm:left-8"><p className="text-xs font-bold uppercase tracking-[.2em] text-[#9bd3c5]">Drip systems</p><h2 className="mt-3 font-display text-3xl sm:text-5xl">Precision along every row.</h2></div></div>
