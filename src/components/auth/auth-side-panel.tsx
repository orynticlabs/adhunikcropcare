  ...
  return (
    <div className="auth-side-panel relative hidden overflow-hidden lg:flex lg:flex-col lg:justify-between">
      ...
      <div className="pointer-events-none absolute inset-0 opacity-80 mix-blend-screen">
        <div className="absolute -right-16 top-10 h-56 w-56 rounded-full bg-[--gold]/10 blur-3xl" />
        <div className="absolute bottom-0 left-0 h-72 w-72 -translate-x-1/3 translate-y-1/4 rounded-full bg-[--leaf]/18 blur-3xl" />
      </div>
          ...
          <div className="space-y-3">
            {items.map((item) => (
              <div key={item} className="flex items-start gap-3">
                <div className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[--gold]/18 text-[--gold] ring-1 ring-white/8">
